                    ...
                    <tbody class='chekboksovi'>
                        <?php foreach ($institutions as $institution): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <?php
                                    echo $this->Link->cLink(__(''), array('action' => 'view', $institution['Institution']['id']), 'fa fa-eye', array(
                                        'title' => 'Pregledaj instituciju'
                                    ));
                                    ?>
                                    <?php
                                    echo $this->Link->cLink(__(''), array('action' => 'edit', $institution['Institution']['id']), 'fa fa-edit', array(
                                        'title' => 'Uredi'
                                    ));
                                    ?>
        <?php
        echo $this->Link->cLink(__(''), array('action' => 'contract', $institution['Institution']['id']), 'fa clip-file-plus', array(
